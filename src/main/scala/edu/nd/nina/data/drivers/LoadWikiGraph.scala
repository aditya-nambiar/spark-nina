...
object LoadWikiGraph {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val g: Graph[WikiVertex, Double] = WikiGraphLoader.edgeListFiles(sc, "hdfs://dsg2.crc.nd.edu/data/enwiki/categorylinks.txt", "hdfs://dsg2.crc.nd.edu/data/enwiki/pagelinks.txt", "hdfs://dsg2.crc.nd.edu/data/enwiki/page.txt", false, 100, 100).cache
