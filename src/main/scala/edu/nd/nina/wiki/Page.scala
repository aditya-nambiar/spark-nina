...
class Page(_namespace: Int, _title: String, _restrictions: Int, _counter: Long, _is_redirect: Int, _is_new: Int, _random: Double, _touched: Long, _latest: Int, _len: Int) {
