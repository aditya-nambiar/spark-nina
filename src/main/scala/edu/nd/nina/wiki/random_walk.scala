  ...
  def bfs(g: Graph[WikiVertex, Double], src:Array[(VertexId,String)]): (Graph[WikiVertex, Double], Double) = {
   ...
   /* val z9= src(8)._1
    ...
    var init = g.mapVertices((id,x) => 
      if( id == z1 ) {var d= new Array[Double](8)
        d(0)=100
        
        
        new WikiVertex(x.dist, x.ns, x.title,false,false,List.empty,List.empty,d,0)}
      
      else if (id== z2)  {var d= new Array[Double](8)
        d(1)=100
        new WikiVertex(x.dist, x.ns, x.title,false,false,List.empty,List.empty,d,0)}
     
      else if(id== z3)  {var d= new Array[Double](8)
        d(2)=100
        new WikiVertex(x.dist, x.ns, x.title,false,false,List.empty,List.empty,d,0)}
      
      else if(id==z4) {var d= new Array[Double](8)
        d(3)=100
        new WikiVertex(x.dist, x.ns, x.title,false,false,List.empty,List.empty,d,0)}
      
      else if (id == z5)  {var d= new Array[Double](8)
        d(4)=100
        new WikiVertex(x.dist, x.ns, x.title,false,false,List.empty,List.empty,d,0)}
      
      else if (id== z6)  {var d= new Array[Double](8)
        d(5)=100
        new WikiVertex(x.dist, x.ns, x.title,false,false,List.empty,List.empty,d,0)}
     
      else if(id==z7)  {var d= new Array[Double](8)
        d(6)=100
        new WikiVertex(x.dist, x.ns, x.title,false,false,List.empty,List.empty,d,0)}
      
       else if(id==z8)  {var d= new Array[Double](8)
        d(7)=100
        new WikiVertex(x.dist, x.ns, x.title,false,false,List.empty,List.empty,d,0)}
    ...
    /*    else if(id==z9) {var d= new Array[Double](25)
        ...
        new WikiVertex(x.dist, x.ns, x.title,false,false,List.empty,List.empty,d,0)}*/
         ...
         else{   new WikiVertex(x.dist, x.ns, x.title,false,false,List.empty,List.empty,new Array[Double](8),0)}
      )
   ...
   // var k=0
    ...
    r.saveAsTextFile("hdfs://dsg2.crc.nd.edu/data/enwiki/random_12_trynew_with6")
