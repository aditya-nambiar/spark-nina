  ...
  def bfs(g: Graph[WikiVertex, Double], src: Array[(VertexId, String)]): (Graph[WikiVertex, Double], Double) = {
    ...
    var init = g.mapVertices((id, x) =>
      if (id == z1) {
        ...
        d(7) = 100
        new WikiVertex(x.dist, x.ns, x.title, false, false, List.empty, List.empty, d, 0)
      }    else if(id==z9) {var d= new Array[Double](20)
        d(8)=100
        new WikiVertex(x.dist, x.ns, x.title,false,false,List.empty,List.empty,d,0)}
      
       else if(id==z10) {var d= new Array[Double](20)
        d(9)=100
        new WikiVertex(x.dist, x.ns, x.title,false,false,List.empty,List.empty,d,0)}
      
        else if(id==z11) {var d= new Array[Double](20)
        d(10)=100
        new WikiVertex(x.dist, x.ns, x.title,false,false,List.empty,List.empty,d,0)}
      
       else if(id==z12) {var d= new Array[Double](20)
        d(11)=100
        new WikiVertex(x.dist, x.ns, x.title,false,false,List.empty,List.empty,d,0)}
      
        else if(id==z13) {var d= new Array[Double](20)
        d(12)=100
        new WikiVertex(x.dist, x.ns, x.title,false,false,List.empty,List.empty,d,0)}
      
        else if(id==z14) {var d= new Array[Double](20)
        d(13)=100
        new WikiVertex(x.dist, x.ns, x.title,false,false,List.empty,List.empty,d,0)}
      
        else if(id==z15){var d= new Array[Double](20)
        d(14)=100
        new WikiVertex(x.dist, x.ns, x.title,false,false,List.empty,List.empty,d,0)}
      
       else if(id==z16) {var d= new Array[Double](20)
        d(15)=100
        new WikiVertex(x.dist, x.ns, x.title,false,false,List.empty,List.empty,d,0)}
      
       else if(id==z17) {var d= new Array[Double](20)
        d(16)=100
        new WikiVertex(x.dist, x.ns, x.title,false,false,List.empty,List.empty,d,0)}
      
        else if(id==z18) {var d= new Array[Double](20)
        d(17)=100
        new WikiVertex(x.dist, x.ns, x.title,false,false,List.empty,List.empty,d,0)}
      
          else if(id==z19) {var d= new Array[Double](20)
        d(18)=100
        new WikiVertex(x.dist, x.ns, x.title,false,false,List.empty,List.empty,d,0)}
      
       else if(id==z20) {var d= new Array[Double](20)
        d(19)=100
        new WikiVertex(x.dist, x.ns, x.title,false,false,List.empty,List.empty,d,0)}
      /*
        ...
        d(24)=100
        new WikiVertex(x.dist, x.ns, x.title,false,false,List.empty,List.empty,d,0)}*/ else { new WikiVertex(x.dist, x.ns, x.title, false, false, List.empty, List.empty, new Array[Double](20), 0) })
